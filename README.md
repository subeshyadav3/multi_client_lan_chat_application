...
- **Token-Guarded Chunked File Transfer:** Rate-limited upload subsystem (2 concurrent uploads, 4 MiB combined budget / 2 MiB per file) streaming 2 KB binary chunks encoded in Base64 (~2.7 KB payload) to prevent stream delimiter collisions.
