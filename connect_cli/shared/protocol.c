...
/* NOTE: the live client/server build and parse lines inline (they must tolerate
 * empty fields and newlines). parse_message() is provided as a reference helper
 * for structured inspection and simple tests. */
